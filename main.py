import sqlite3;import random;h=0
while h==0:
    ...
    if SL=='LOGIN':
        ...
        N=sqlite3.connect('U.db');Q=N.cursor();U=input('Enter Username: ');E=input('Welcome, Please Create Your Password: ');P=100;Q.execute('INSERT INTO U VALUES(?,?,?)',(U,E,P));N.commit();R=Q.fetchall();h+=1
